...
public class WaterDropMain extends BaseLiveWallpaperService implements SharedPreferences.OnSharedPreferenceChangeListener, IAccelerometerListener {
     ...
     public Scene onLoadScene() {
          ...
          scene.registerUpdateHandler(new IUpdateHandler() {
               ...
               public void onUpdate(float arg0) {
                    ...
                    mAccelerometerOnOff =sp.getInt("speed",1);
                    mNoOfObject =sp.getInt("objects",1);
                    mObjectSizeSelection =sp.getInt("size",1);
                    mFallingDirection =sp.getInt("direction",1);
     ...
     public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
          ...
          Log.d("Wasadd","onSharedPreferenceChanged");
          /**
         ...
         /* mAccelerometerOnOff = Integer.valueOf(mPrefs.getString(ACCELEROMETER_ON_OFF, "1"));
          ...
          Log.d("awadsd", String.valueOf(sharedPreferences.getInt("direction",1)));
